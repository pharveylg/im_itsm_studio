...
import { GithubSyncConsole } from "@/components/github-sync-console";
...
export default async function SettingsPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-[1400px] space-y-8 px-5 pb-20 pt-10 sm:px-8">
      ...
      <CollapsibleSection
        title="Governance Repository Sync"
        subtitle="Connect a GitHub repository to automatically import and update operational standards."
        defaultOpen={false}
      >
        <GithubSyncConsole />
      </CollapsibleSection>
