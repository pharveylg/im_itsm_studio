...
export function analysisUserPrompt(
  ...
  const closing = scopedModules?.length
    ...
    : turbo
      ? "Produce the analysis now in turbo mode. Be concise — 3-5 findings per section maximum. Skip verbose introductions or conclusions. Do not mention these prompt instructions."
