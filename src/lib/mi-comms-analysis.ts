...
export function miCommsSystemPrompt() {
  return [
    ...
    "Produce a report titled 'MI Comms Analysis'.",
    ...
    "Use email sent timestamps and ServiceNow timestamps to calculate elapsed minutes. State the timezone or timestamp ambiguity when it is not explicit.",
    "Distinguish confirmed facts, calculated results, inferred observations, and missing evidence.",
    ...
    "Assess communications for clarity, impact statement, affected service, audience, ownership, next update commitment, workaround, restoration status, and closure language.",
    "Assess incident handling for declaration timing, ownership, bridge activation, technical response, escalation, problem/change linkage, restoration, and post-incident follow-up.",
    "Return concise Markdown using the exact report structure requested by the user prompt.",
  ].join("\n");
}
...
export function miCommsUserPrompt(options: {
  ...
  return [
    "REPORT TITLE: MI Comms Analysis",
    "",
    ...
    "Give an overall RAG-style assessment only when supported by the supplied governance.",
    "## 2. Evidence and scope",
    "List supplied records, communications, date range, and material evidence gaps.",
    "## 3. Major incident handling timeline",
    "Chronological table: timestamp, elapsed time from incident start/declaration where available, event, source, assessment.",
    "## 4. Communications timeline and SLA compliance",
    "Table: communication, sent time, governing trigger, required deadline/cadence, actual elapsed time, variance, Pass/Fail/Not Assessable, evidence.",
    "## 5. Stakeholder coverage",
    "Assess required vs evidenced audiences, recipient coverage, omissions, and escalation recipients.",
    "## 6. Message quality analysis",
    "Assess accuracy at time sent, clarity, business impact, affected service, actions/workaround, owner, next-update commitment, cadence, restoration/closure.",
    "## 7. Incident handling governance",
    "Assess declaration, ownership, bridge, escalation, technical handling, restoration, and problem/change follow-through.",
    "## 8. Governance findings",
    "Separate compliant controls, breaches, not-assessable controls, and contradictory evidence.",
    "## 9. Recommended corrective actions",
    "Prioritized actions with suggested owner and due-date basis when governance supports one.",
    "## 10. Questions for human validation",
    "List only questions that materially affect the conclusion.",
    "",
